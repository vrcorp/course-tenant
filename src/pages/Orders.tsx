    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-xs text-muted-foreground">
              {Math.round((totalCustomers / orders.length) * 100)}% conversion rate
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage and track customer orders and payments</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Handle pending payments and refunds</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <Button className="w-full" variant="outline">
              Process Pending Payments ({pendingOrders})
            </Button>
            <Button className="w-full" variant="outline">
